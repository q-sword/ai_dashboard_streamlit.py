...
# Overlaying the quantum fluctuation and string theory resonance on a single plot
...
w_wavefunction_placeholder = st.empty()
...
with w_wavefunction_placeholder.container():
    ...
    ax.legend()
    ax.grid(True, linestyle='--', alpha=0.7)
    w_wavefunction_placeholder.pyplot(fig)
